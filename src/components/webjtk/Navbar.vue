<template>
  <div>
    <div class="absolute z-10 w-full shadow-sm">
      <!-- Navbar -->
      
      <div class="flex header-color items-center px-4 py-3 sm:p-0">
        <a href="/">
          <img class="img-logo" src="/img/icons/geowisata/polban.png" />
        </a>
        <div class="sm:hidden">
          <button
            @click="isOpen = !isOpen"
        ...
        <a href="/" class="text-black font-montserrat font-semibold rounded px-8"> Jurusan Teknik Komputer dan Informatika POLBAN </a>
      </div>

      <div class="flex navbar-color items-center justify-between px-8 py-33 sm:p-0">
        <nav
          :class="isOpen ? 'block' : 'hidden'"
          class="px-6 pt-2 pb-4 sm:flex sm:p-0"
        >
        <!-- 
          <a
            href="#"
            class="dropdown relative inline-block mt-1 block px-2 py-1 text-white font-montserrat font-semibold rounded"
          >
        ...
        -->
          <a
            href="#"
            class="dropdown relative inline-block mt-1 block px-6 py-1 text-white font-montserrat font-semibold rounded"
          >
          ...
          <a
            ...
            :key="index"
            class="navlist mt-1 block px-2 py-1 text-white font-semibold font-montserrat rounded text-white hover:underline"
          >
            {{ navbar.navbar_title }}
          </a>
        </nav>
...
.navbar-color {
  background-color: rgb(26, 65, 103);
